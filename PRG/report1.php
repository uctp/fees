...
<div id = "leftbox"> 
	...
	<div class="Title">
		...
		<p> Parent/Student Copy </p>
		</div>
		
		<table class='table1'>
		
		<tr>
		<td> Date : <?php echo $currendate ?> </td>
		</tr>
			...
			<tr>
				...
				<td>         </td>
				<td>        </td>
				<td>Payment Date : <?php echo date("d-m-Y", strtotime($paiddate)) ?> </td>
			</tr>
			<tr>
	...
	<p style="width:450px;margin:5px;margin:30px "><script> document.write(number2text(<?php echo ($paid) ?>)) ;</script></p>
