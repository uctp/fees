...
$res13 = $Result1['date_of_birth'];
$res14 = $Result1['date_of_joining'];
$res15 = $Result1['station'];
$res16 =$Result1['newold'];
$res = Array($res1,$res2,$res3,$res4,$res5,$res6,$res7,$res8,$res9,$res10,$res11,$res12,$res13,$res14,$res15,$res16);
//  echo $res ;
