...
<div>
<form action="edit.php" method ="post"  id="form1" name="form1" onload="getDate()">
<table >
 <tr> 
...
<tr>
<td >
		<input type="date" id="tdate" name="tdate"  value= "<?php echo $date ?>" min="2018-01-01" max="2019-12-31" autofocus="autofocus" class="my1" onload="getDate()">
</td>
<td width ="10px" > 
	<input type"text"  id="grno" name="grno" class="my" value="<?php echo $grno ?>"  autofocus="autofocus" maxlength="6"  readonly />
 </td>
 <td> 
	<input type"text"  id="challan" name="challan" value = "<?php echo $challan ?>" maxlength="6"  class="my"  />
 </td>
 <td> 
 <select name="ttruckno1" id="ttruckno1"   class ="my1" onchange="myvalue()">
...
?>
 ...
 <td>
 <select name="tself" id="tself" class="my2">
 <?php if ($self =="SELF") { ?>
 ...
 <input type="number" id="tqty" name="tqty" value="<?php echo $qty ?>"  min="0.00" step="0.01"   class="my" onkeyup="dolab()" >
 </td>
...
<td>
<select class="country" name="tstation" id= "tstation"  style= "font-size:12pt;height:30px;border : 1px solid blue;width: 170px;"  >
...
<td>
 ...
 <input type="text" id="tbill" name="tbill" value="<?php echo $billno ?>"   class="my" >
 </td>
 <td>
  <input type="number" id="short1" name="short1"  value="<?php echo $short1 ?>"   class="my" >
 </td>
 <td>
 <input type="text" id="spage" name="spage" value="<?php echo $spage ?>" maxlength="4" class="my" >
 </td>
 <td>
 ...
 <input type="number" id="labour" name="labour" oninput="setTwoNumberDecimal(this)" value="<?php echo $labour ?>" class="my" onkeyup="dolab()">
 </td>
 <td>
 <input type="text" id="lpage" name="lpage" value="<?php echo $lpage ?>" maxlength="4" class="my" >
 </td>
...
<tr>
<td>
 <input type="number" id="toll" name="toll"  oninput="setTwoNumberDecimal(this)" value="<?php echo $toll ?>" class="my" >
 </td>
 <td>
...
<td>
  <input type="number" id="advance" name="advance" oninput="setTwoNumberDecimal(this)" value="<?php echo $advance ?>"   class="my2" onkeyup="dolab()">
 </td>
 <td>
 
 <input type="text" id="page1" name="page1" value ="<?php echo $page1 ?>" maxlength="4"  class="my" >
 </td>
 <td>
 ...
 <input type="number" id="bilty" name="bilty" oninput="setTwoNumberDecimal(this)" value="<?php echo $bilty ?>"   class="my" onkeyup="dolab()" >
 </td>
 <td>
 
 <input type="number" id="paid" name="paid"  oninput="setTwoNumberDecimal(this)" value="<?php echo $paid ?>"   class="my" onkeyup="dolab()" >
 </td>
 <td>
 
 <input type="text" id="page2" name="page2" value="<?php echo $page2 ?>" maxlength="4" class="my" >
 </td>
...
<td>
 ...
 <input type="number" id="tshort" name="tshort"  oninput="setTwoNumberDecimal(this)" value="<?php echo $shortval ?>"  class="my" >
 </td>
<td>
